    ...
    const handleEmailSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.hasSecurityQuestion) {
                ...
                // No security question, send email directly
                await sendResetLink()
            }
        } catch (err: any) {
            ...
            <CardContent>
                ...
                {step === 'email' && (
                    <form onSubmit={handleEmailSubmit} className="space-y-5">
                        ...
                        <p className="text-center text-sm text-neutral-500">
                            <Link href="/login" className="text-[#7C3AED] hover:underline font-medium inline-flex items-center gap-1">
                ...
                {step === 'choose-method' && (
                    <div className="space-y-4">
                        <div className="p-4 bg-[#f8f7fb] rounded-xl">
                        ...
                        <button
                            ...
                            className="w-full p-4 border-2 border-neutral-200 rounded-xl hover:border-[#7C3AED] hover:bg-[#7C3AED]/5 transition-all text-left group"
                        >
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-lg bg-[#7C3AED]/10 flex items-center justify-center group-hover:bg-[#7C3AED] transition-colors">
                                    <HelpCircle className="w-5 h-5 text-[#7C3AED] group-hover:text-white transition-colors" />
                                </div>
                                <div>
                        ...
                        <p className="text-center text-sm text-neutral-500">
                            <button 
                                ...
                                className="text-[#7C3AED] hover:underline font-medium inline-flex items-center gap-1"
                            >
                                <ArrowLeft className="w-3 h-3" />
                                Use different email
                            </button>

...
const steps = [
    ...
    },
    {
        ...
        duration: '1 minute',
        description: 'Set up Email alerts so you never miss an order.',
        details: [
            'In Store Settings, add your Email Id',
            'Enable order notifications',
            'Test by placing a test order (optional)',
            'You will receive Email alerts for: new orders, payment confirmation, buyer messages',
    ...
    },
    {
        ...
        details: [
            ...
            'Share tracking with buyer via Email',

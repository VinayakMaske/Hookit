        ...
        <div className="grid md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-neutral-400 text-sm leading-relaxed mb-6 max-w-xs">
              The easiest way to turn any idea into a discoverable Hook. Share your creativity with the world.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-500 transition-all duration-300">
          ...
          {/* Product Links */}
          <div>
            <h4 className="font-semibold mb-4 text-sm uppercase tracking-wider text-neutral-300">Product</h4>
      ...
      <div className="border-t border-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-neutral-500 text-sm flex items-center gap-1">
            Made with <Heart className="w-3 h-3 text-pink-500 fill-pink-500" /> for creators worldwide
          </p>
        </div>
      </div>
    </footer>
